...
Το \en{U-Net} \cite{ronneberger2015unet} αποτελεί σημείο αναφοράς στην ιατρική τμηματοποίηση. Πρόκειται για συμμετρική αρχιτεκονική \en{encoder-decoder} με \en{skip connections}:
\begin{itemize}
...
\includegraphics[width=0.4\linewidth]{../Images and data for diploma/Screenshot 2026-01-26 at 19.02.46.png}
 \caption{Μηχανισμός \en{residual connection} στην αρχιτεκτονική \en{ResNet} \cite{he2016resnet}}
\label{figure4.1}
\end{figure}

\paragraph{Γιατί υπολείμματα.}
Οι υπολειμματικές συνδέσεις (\ref{figure4.1}) διευκολύνουν τη ροή κλίσεων και επιτρέπουν 
...
Η \en{Attention U-Net} εισάγει \en{attention gates} στις \en{skip connections}, ώστε το δίκτυο 
...
Αντί για πλήρη \en{attention} σε όλα τα \en{tokens}, η προσοχή υπολογίζεται σε τοπικά παράθυρα, τα οποία μετατοπίζονται (\en{shifted windows}) ώστε να επιτυγχάνεται ανταλλαγή πληροφορίας μεταξύ γειτονικών παραθύρων.

\paragraph{Γιατί ταιριάζει σε \en{3D}.}
Η ιεραρχία μειώνει προοδευτικά το πλήθος \en{tokens} (\en{patch-merging}), 
βελτιώνοντας την κλιμάκωση. Παράλληλα, οι \en{skip connections} προς έναν 
\en{U-shaped decoder} διατηρούν την χωρική ακρίβεια.
...
(προεπεξεργασία, \en{patch sampling}, loss, metrics και inference), ώστε η
...
Συνοψίζοντας, οι οικογένειες μοντέλων διαφέρουν ως προς το \textbf{πώς} συλλέγουν συμφραζόμενο:
\begin{itemize}
  ...
  \item \textbf{\en{SSM/Mamba-based}}: στόχος η μακρινής εμβέλειας μοντελοποίηση με καλύτερη κλιμάκωση, κάτι ιδιαίτερα ελκυστικό σε \en{3D} τμηματοποίηση.
\end{itemize}
