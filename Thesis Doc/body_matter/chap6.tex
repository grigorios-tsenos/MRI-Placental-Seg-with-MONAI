...
Το \en{UNETR} λειτουργεί ως \en{outlier} φτάνοντας χαμηλό\-τερο \en{best Dice}, γεγονός που
συμφωνεί με τη συνολική του υστέρηση στον Πίνακα \ref{tab:main_results}.
Αντιθέ\-τως, το \en{SwinUNETR} παρουσιάζει πιο ομαλή και σταδιακή βελτίωση και
πλησιάζει τις \en{CNN}-βασισμένες προσεγγίσεις, χωρίς όμως να ξεπερνά την
κορυφή (\en{SegResNet}/\en{SegMamba}). Το αποτέλεσμα είναι ενδεικτικό ότι η
ιεραρχική, κινούμενων παραθύρων μηχανισμός προσοχής του \en{Swin} είναι πιο κατάλληλη (και
πιο σταθερή) από ένα \en{ViT-style encoder} \cite{hatamizadeh2022swinunetr} στο συγκεκριμένο πρόβλημα.

\paragraph{\en{SSM/Mamba-based} συμπεριφορά και χωρητικότητα.}
Οι παραλλαγές \en{SegMamba} συγκλί\-νουν γρήγορα σε υψηλές τιμές \en{Dice} και
...
Οι καμπύλες \en{training} και \en{validation loss} μειώνονται παρά\-λληλα και
...
Στην επόμενη ενότητα εξετάζονται οπτικά παραδεί\-γματα προβλέψεων και τυπικών
...
\begin{itemize}
  \item \textbf{Υπο- ή υπερ-τμηματοποίηση} (απώλεια άκρων, διαρροές),
...
(\en{Dice}+\en{CE}) είναι πιο ευαίσθητο σε αβεβαιότητα/λάθη κοντά στα όρια,
